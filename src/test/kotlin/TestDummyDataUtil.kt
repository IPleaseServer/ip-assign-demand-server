...
object TestDummyDataUtil {
    fun reason() = listOf("날이 좋아서", "날이 좋지 않아서", "날이 적당해서", "그냥").random()
    ...
    fun assignIp() = String.format("%s.%s.%s.%s", Random.nextInt(0, 255), Random.nextInt(0, 255), Random.nextInt(0, 255), Random.nextInt(0, 255))
